export default {
	...
	settings: {
		...
		webdavUrl: {
			...
			desc: 'The URL of your WebDAV server (e.g., https://dav.example.com/dav/)',
		},
		account: {
			name: 'Account',
		...
		login: {
			name: 'Connect',
			desc: 'Click to test connection',
			success: 'Connection successful',
			failure: 'Connection failed, please try again',
		},
		loginMode: {
			name: 'Login mode',
			manual: 'Manual input',
		...
		cache: {
			...
			dumpDesc:
				'The plugin stores remote folder information locally. When switching devices, this data is lost and must be rebuilt before syncing. With many files, rebuilding can be slow. Export saves this data to the WebDAV server; Import retrieves it, allowing immediate syncing on new devices.',
			restoreName: 'Import cache',
			restoreDesc:
				'Import previously exported cache data from the WebDAV server to your device. This lets you sync immediately on a new device without the long waiting time normally needed to scan all your files.',
			restore: 'Import',
			clearName: 'Clear local cache',
			clearDesc:
				'Delete local cache data stored on this device only. This action cannot be undone and will require rebuilding the cache before the next sync. Your data on the WebDAV server remains intact.',
			clear: 'Clear',
			...
			clearModal: {
				...
				confirm: 'Confirm clear',
				deltaCache: {
					name: 'Directory traversal cache',
					desc: 'Stores incremental information about remote directory traversal.',
				},
				syncRecordCache: {
	...
	sync: {
		...
		suggestUseClientForManyTasks:
			'Tip: When there are many sync tasks, the initial sync may take a long time. Please be patient.',
		modalTitle: 'Syncing',
